...
// P8.3 extraction: publicBaseUrl/audioUrlFor/selectEligible живут в agent/reviewSession.js
// (channel-neutral сервис — ОДИН селектор и ОДНО due-окно на обе поверхности, §20.1/§2-v2);
// этот модуль — Telegram-BOT-адаптер (форматирование/доставка/reply-binding).
const reviewSession = require(path.join(__dirname, "..", "reviewSession"));
const { publicBaseUrl, audioUrlFor, selectEligible } = reviewSession;
