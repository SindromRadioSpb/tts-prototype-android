...
const CLIENT_FAULT_CODES = new Set([
  ...
  "AA_ACTIVITY_SINCE_OUT_OF_RANGE", "AA_REVIEW_NOTHING_SCHEDULED",
  // S-пакет — личные тексты (S1 list + S2 content). RECONSENT отделён от CONSENT_REQUIRED
  // (критика R15: «включи синк» и «подтверди обновлённую карту» — разные действия владельца).
  "AA_PERSONAL_TEXTS_CONSENT_REQUIRED", "AA_PERSONAL_TEXTS_RECONSENT_REQUIRED",
  "AA_PERSONAL_TEXTS_NOT_SYNCED", "AA_PERSONAL_TEXT_NOT_FOUND",
  "AA_TEXT_ACCESS_NOT_GRANTED", "AA_TEXT_ACCESS_EXPIRED", "AA_ARTIFACT_UNREADABLE",
  "AA_INVALID_INPUT", "AA_NOT_FOUND",
]);
