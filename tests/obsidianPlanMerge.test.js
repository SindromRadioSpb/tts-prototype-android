...
function plan(id, title, shared = "same") {
  return { schema: "linguistpro-obsidian-package-plan-v2", text_id: id, text_title: title,
    ...
    files: [
      ...
      { path: `_LinguistPro/texts/${id}/Текст.md`, kind: "text", bytes: title.length, content: title },
    ], external_files: [{ path: "_LinguistPro/media/audio/key.mp3", asset_key: "key", size_bytes: 3 }] };
}
