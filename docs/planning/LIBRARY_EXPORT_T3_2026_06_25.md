...
**Решение владельца 2026-06-25: ЗАКРЫТЬ эпик T3.** Опц. будущий трек — P2 (скорость фетча) и/или лёгкий retry для ~0.5% пропущенных клипов на длинных прогонах (сейчас они уходят в `missing_audio.json`).
