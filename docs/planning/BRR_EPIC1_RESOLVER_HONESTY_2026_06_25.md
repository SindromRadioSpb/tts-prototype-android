# Эпик 1 — Честность резолвера · P0

**Дата:** 2026-06-25 · **Статус:** ✅ **SHIPPED+PROD** (ядро P1.0–P1.2 + хвост broaden/auto-Tier-3/participle-soften). Прод SW `v3.10.88-participle-soften`. Хвост честен 90.3%; остаток = ~9 имён (F6, опц.). Хронология фаз — секции ниже (§P1.0/§P1.1/§P1.2/§ХВОСТ/§participle-soften). Исходный recon-дизайн (для истории) — §1–§6.
