...
**Честный предел:** participle→noun (~33) + имена (~9) остаются — офлайн неразрешимы без фабрикации/риска; participle-soften (демоция «точно»→«вероятно» на content-POS-расхождении) — отдельный взвешенный шаг (не в этой итерации).
