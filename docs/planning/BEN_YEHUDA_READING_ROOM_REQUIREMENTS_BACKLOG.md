...
- **Open (full-corpus delivery):** реализация per-work served-on-open + OPFS LRU + tier-publish. **Дизайн закрыт: D1–D5 решены владельцем 2026-06-10** → `docs/planning/BEN_YEHUDA_DELIVERY_26K_PLAN.md §7`; код — отдельный инкремент (Проход 3).
