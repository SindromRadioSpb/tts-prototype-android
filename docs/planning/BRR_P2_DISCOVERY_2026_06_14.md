...
### B. Журнал смоук-чека (заполнять по ходу проверки владельца)
| # | Что не так / недоработка | Где (стадия/файл) | Серьёзность | Статус |
|---|---|---|---|---|
| — | _(пусто — добавлять находки смоук-чека)_ | | | |
