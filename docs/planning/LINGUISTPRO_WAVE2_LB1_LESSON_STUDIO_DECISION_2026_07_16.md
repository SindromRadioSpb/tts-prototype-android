...
**Implementation target:** policy `lesson-builder-lb1-v2`, schema 2, app `3.11.178`.
...
- Independent fixtures live in `scripts/premium/fixtures/lesson-builder-lb1/`: a versioned rubric plus valid/adversarial composition cases. Current targeted gate: `65/65`.
