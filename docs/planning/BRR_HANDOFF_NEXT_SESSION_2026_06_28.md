...
- **🎉 Phase D ЗАВЕРШЁН. СЛЕДУЮЩЕЕ:** опц. **D7.1** (месячный heatmap из `study_day`) · **3b** (function-usage card, R2, нужен content-authoring+sign-off) · **5/6/9** из `BRR_UX_AUDIT_2026_06_25.md` (graded-momentum / curated-library / karaoke-UX).
