...
- **Прод:** `https://linguistpro.kolosei.com` · живёт **v3.11.62** · git **HEAD `7d61a88`** на `main` · рабочее дерево чистое (кроме служебного `.remember/remember.md`).
