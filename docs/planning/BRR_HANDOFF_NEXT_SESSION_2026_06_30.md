...
- **Прод:** `https://linguistpro.kolosei.com` · живёт **v3.11.60** · git **HEAD `6a43f5f`** на `main` · рабочее дерево чистое (кроме служебного `.remember/remember.md`).
