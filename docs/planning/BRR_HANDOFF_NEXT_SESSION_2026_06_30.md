...
- **Прод:** `https://linguistpro.kolosei.com` · живёт **v3.11.63** · git **HEAD `785b62c`** на `main` · рабочее дерево чистое (кроме служебного `.remember/remember.md`).
