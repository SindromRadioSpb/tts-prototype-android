...
- **Прод:** `https://linguistpro.kolosei.com` · живёт **v3.11.58** · git **HEAD `555c4dd`** на `main` · рабочее дерево чистое (кроме служебного `.remember/remember.md`).
