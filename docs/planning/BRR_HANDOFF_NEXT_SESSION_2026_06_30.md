...
- **Прод:** `https://linguistpro.kolosei.com` · живёт **v3.11.64** · git **HEAD `9ef819c`** на `main` · рабочее дерево чистое (кроме служебного `.remember/remember.md`).
