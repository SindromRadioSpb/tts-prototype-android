...
- **R2 — serve unsourced: ✅ SHIPPED v3.11.144** (спека v2 после adversarial-критики wf_d242bed2: 3 BLOCKER + 8 MAJOR приняты; гейты memory-canon 72/72 [+4 R2-scan] · reader-morph · reader-parity): лестница **heal-first**, все ярусы под гейтом честности:
