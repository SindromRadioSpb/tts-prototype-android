...
> **Статус маршрутизации — 2026-07-16:** этот документ сохраняется как исторический канон программы CLG/P7/P8. Его встроенный промт §4 больше не является стартовым для текущей Wave 2. G0, C3a, N1, LB0, LB1 и LB2-A закрыты; дальнейшая lesson-quality evidence работа отложена с воспроизводимым handoff. Следующая отдельная сессия — documentation-only S0 Scale Envelope по `LINGUISTPRO_WAVE2_S0_SCALE_ENVELOPE_EXECUTION_PROMPT_2026_07_16.md`.
