...
> **Статус маршрутизации — 2026-07-16:** этот документ сохраняется как исторический канон программы CLG/P7/P8. Его встроенный промт §4 больше не является стартовым для текущей Wave 2. Текущий прод — `3.11.181`; G0, C3a, N1, LB0 и LB1 закрыты. Следующая сессия по качеству уроков стартует с `LINGUISTPRO_WAVE2_LB2_AI_QUALITY_EXECUTION_PROMPT_2026_07_16.md`.
