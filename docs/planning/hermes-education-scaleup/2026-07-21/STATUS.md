...
## Горизонт 2 — статус: IN_PROGRESS (G-H2-START PASS; H2.1–H2.6 + H2.G1 CLOSED; H2.7 PLANNED; Group Song Corpus P0 CLOSED; H1 monitoring параллельно)
...
| H2.7 Owner-live+closure | prompts/H2_07_OWNER_LIVE_AND_CLOSURE.md | PLANNED — unblocked by H2.6 CLOSED; canonical closure audit pending |
