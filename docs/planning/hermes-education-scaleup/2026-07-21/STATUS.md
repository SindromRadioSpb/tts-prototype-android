...
| H2.5 ivrit.ai ASR MCP | prompts/H2_05_IVRIT_AI_ASR.md | ENGINEERING_COMPLETE — local stdio tool installed; contract/safety smoke 5/5 + corrupt PASS; CPU benchmark and fresh WebUI tool discovery PASS; real-recording owner-live pending, not CLOSED |
