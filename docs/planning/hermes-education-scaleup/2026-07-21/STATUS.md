...
Обновлено: 2026-07-21 (H1.0 Gemini rerun: BLOCKED, 1/5 PASS, 2 FAIL, 2 provider-blocked).

## Горизонт 1 — статус: BLOCKED (H1.0 acceptance)

| Слайс | Промт | Статус | Гейты | Вердикт владельца | Ссылки/заметки |
|---|---|---|---|---|---|
| H1.0 Trainer policy | prompts/H1_01_TRAINER_POLICY_AND_GUARDRAILS.md | BLOCKED | policy reproduction PASS; Gemini S1–S5: 1/5 PASS, 2 FAIL, 2 provider-blocked | — | `gemini-3.6-flash`: S2 PASS; S1/S3 FAIL; S4/S5 429 after 2 attempts; `hermes-side/h1.0/` |
