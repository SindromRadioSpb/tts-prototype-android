...
| C4 | DONE_NO_GO / CLOSED / SMOKE_LIMITED #4 | 20/20 blind ratings: note-enabled 4 (20%), without-note 3, ties 13; threshold ≥14/20 не пройден. Product integration остановлена, temporary consent отозван. Состав 1 pre-existing + 19 `owner_approved_agent_draft` не позволяет обобщать на зрелый historical corpus |
