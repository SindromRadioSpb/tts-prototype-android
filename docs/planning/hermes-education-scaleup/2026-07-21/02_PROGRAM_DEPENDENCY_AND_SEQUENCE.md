...
| H1.* → H1.8 → H2 | evidence | H2-инвестиции (код LinguistPro) оправданы только если H1 owner-live показал реальное использование петель (08 §3: continuation evidence) |
...
## 4. Что нельзя начинать до H1 owner-live evidence

- **Весь H2**: код LinguistPro (новые инструменты, миграции goal-store) — только после G-H2-START (10 §3). Причина: H2 — недели инженерии; evidence H1 (юзер реально ведёт разговорные сессии/письмо/ретроспективы) — единственное честное основание.
- Исключение НЕ делается даже для «маленьких» H2-слайсов (Nakdan): дисциплина горизонтов дороже недели ожидания.
