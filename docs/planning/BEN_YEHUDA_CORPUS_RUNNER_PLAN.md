...
- ▶ **Следующий кодовый инкремент = giant-pass** (§3, deferred-giant → chapterized parts на изолированном temp-ledger). Перед rest-tier — niqqud-probe на 20–50 rest works.
