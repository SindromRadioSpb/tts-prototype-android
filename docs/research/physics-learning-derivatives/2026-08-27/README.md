...
This directory contains the local R1 derivative pilot for the published
`physics-year1-problems` corpus.
...
- Independent solutions: generated from canonical conditions/printed diagrams, never
  from handwritten work; see the solution-ledger review summary.
