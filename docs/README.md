...
- `PRODUCT_PULSE.md` — first-party серверная продуктовая аналитика: версионированный wire contract, privacy-safe события и свойства, Umami и правила расширения.
