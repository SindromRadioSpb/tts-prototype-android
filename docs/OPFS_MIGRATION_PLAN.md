...
- **A. Hard blockers (без них default-on опасен):** A1 first-open prompt ✅, A2 mobile dogfood ✅ (iPhone+Android), A3 cross-device ZIP ✅, A4 concurrent tabs guard (in progress).
