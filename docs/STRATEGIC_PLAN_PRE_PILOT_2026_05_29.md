...
> **⚠ ОБНОВЛЕНО 2026-06-03 — пилот перенесён на ~2 месяца.**
> Новое целевое окно пилота: **2026-08-04…08-11**; новое pre-pilot окно: **~2026-07-14…08-03**.
> Freeze-zone включается с началом пилота (~2026-08-04). Освободившееся окно отдано премиум-треку;
> первый эпик — **бескомпромиссный редизайн «Карты знаний» (root-centric)**, см.
> `docs/KNOWLEDGE_MAP_REDESIGN_v3_8.md`. P0-блокеры пилота возвращаются в фокус ~2026-07-14.

Pre-pilot window — **~1–2 недели** до запуска пилота (исходный целевой период был 2026-06-04…06-11; **перенесён → 2026-08-04…08-11**).
...
- Prod: Hetzner CX23 + Coolify, `https://linguistpro.kolosei.com`, image `glmw0wjd6nm70fntxgjy6fkp:99df393d7eb7…`.
