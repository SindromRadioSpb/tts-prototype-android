---
name: srs-engine-contract
description: SRS engine governance — cards, today queue, review ratings/events. Требует соблюдения docs/CONTRACTS_SRS.md, docs/CONTRACTS_ANALYTICS.md (часть events), docs/DB_SCHEMA.md, docs/SMOKE-CHECK.md.
---
