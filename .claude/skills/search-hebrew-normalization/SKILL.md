---
name: search-hebrew-normalization
description: Rows Search PRO governance — нормализация иврита, auto language detect, snippet+highlight. Требует соблюдения docs/CONTRACTS_SEARCH.md, docs/SMOKE-CHECK.md, docs/DB_SCHEMA.md.
---
