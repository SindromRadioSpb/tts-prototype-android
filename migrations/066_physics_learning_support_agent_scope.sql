-- Physics Year 1 R12: a separate OAuth scope for reviewed derivative text.
-- Existing publication source/resource scopes do not silently widen.
...
CREATE TABLE agent_connection_grants_new (
  ...
  scope             TEXT NOT NULL CHECK(scope IN (
                      ...
                      'reading.publication.resource.read','reading.publication.derivative.read')),
