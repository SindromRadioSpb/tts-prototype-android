-- H2.2 get_text_coverage — widen agent_connection_grants CHECK from 16 to 17
-- scopes by adding learner.coverage.read. Owner explicitly approved this
-- correction on 2026-07-23: both Ben-Yehuda corpus works and consented personal
-- texts must be available to Hermes through the same deterministic tool.
--
-- This is a consent-store compatibility migration only: it adds no learner
-- table and changes no review_log / srs_projections data. Pattern mirrors 054.
