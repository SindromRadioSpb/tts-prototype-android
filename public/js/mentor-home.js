...
(function (root, factory) {
  ...
  function renderLessonDraft(box,draft,store,meta){
    ...
    if(draft.quality&&draft.quality.tier==="basic_plan")box.appendChild(el("div","mentor-lb-quality-basic",qualityReason==="LLM_OUTPUT_INVALID"
      ?t("room.lesson.basicPlanRejected","AI-черновик отклонён проверкой качества · показан безопасный базовый план.")
      :t("room.lesson.basicPlan","AI не дал допустимый черновик · показан безопасный базовый план.")));
