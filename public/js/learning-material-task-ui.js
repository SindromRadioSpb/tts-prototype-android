(function(){
  ...
  window.LearningMaterialTaskUI={configure:value=>{operations=value;},start,list,labels,stageModel,liveDetail,quoteLine,qualityNotes,resumeNote,foregroundNote,paidNotes,titleNotice,applyTitleNotice};
