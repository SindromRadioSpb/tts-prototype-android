(function(){
  ...
  async function showTask(job,d){
    ...
    const steps=element('ol');for(const phase of ['imported','translating','saved','ready'])steps.append(element('li',t(phase)));d.append(steps);
  ...
  async function start(){
    ...
    if(!input.source_text){d.append(element('p',t('missing')));button(d,t('close'),()=>d.close());return;}
