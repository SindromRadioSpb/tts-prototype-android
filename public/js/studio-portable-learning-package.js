...
(function (root, factory) {
  ...
  async function open(options){
    options=options||{};const modal=ensureModal(),tabs=modal.querySelector('#p2PortableTabs');modal.querySelector('#p2PortableTitle').textContent=tr('studio.portable.hub','Transfer & backups');modal.querySelector('#p2PortablePrivacy').textContent=tr('studio.portable.privacy','Everything stays in this browser unless you explicitly download or choose a file. Provider secrets are never included.');
