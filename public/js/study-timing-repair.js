(function(){
  ...
  async function open(id){
    ...
    const estimate=async()=>{
      ...
      quote=result.timingQuote;status.textContent=tr('cost',{price:quote.estimatedUsd.toFixed(4)});
    };
    const verify=async()=>{
