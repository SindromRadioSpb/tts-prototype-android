---
name: analytics-events-contract
description: Analytics PRO governance — events schema, time-spent без listeners, cohort. Требует соблюдения docs/CONTRACTS_ANALYTICS.md, docs/DB_SCHEMA.md, docs/SMOKE-CHECK.md.
---
