...
def test_video_size_boundary_is_3_gib():
...
@pytest.mark.asyncio
async def test_upload_limit_is_3_gib_and_reports_too_large(tmp_path):
    assert MediaJobManager.MAX_BYTES == 3 * 1024 * 1024 * 1024
