## 2026-06-27 | main | Track-any-word T-a + T-b (статус красит любое + ручной перевод неизвестных)

**Прод app+SW → v3.11.15** (после пуша; верифи в процессе/готово). Зал-only, parity-safe, resolver не тронут.
