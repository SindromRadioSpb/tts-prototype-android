...
const fixtures = Object.freeze({
  ...
  get_agent_connection: Object.freeze({ schema_version: 'aa.connection.1.0.0', connection_id: connectionId, oauth_client_id: clientId, client_display_name: 'Fixture client', connection_status: 'ACTIVE', granted_scopes: Object.freeze(allScopes.filter((scope) => !['morphology.read', 'learner.coverage.read', 'reading.group_corpus.read', 'learner.group_coverage.read'].includes(scope))), access_expires_at: expiresAt, consent_version: 'consent-fixture', capability_version: 'aa-v0.1', downstream_retention_notice: 'EXTERNAL_STORAGE_OUTSIDE_LINGUISTPRO', generated_at: new Date(nowSeconds * 1000).toISOString() }),
