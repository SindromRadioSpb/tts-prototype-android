...
graph.getKnownWords = async () => [{ item_key: "item:0" }];
...
], goal: "Understand both texts", explanationLanguage: "en", approximateLevel: "A2", durationMinutes: 20, focus: "reading" }; }
...
(async () => {
  ...
  ok(html.includes("@media (max-width: 480px)") && html.includes("mentor-lb-grid"), "mobile 380px single-column fallback present");
