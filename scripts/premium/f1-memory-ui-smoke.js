...
const must=["mentor-memory-wrap","mentor-memory-card","mentor-memory-later","memoryLaterButton(\"AGENT_TASK\"","memoryLaterButton(\"AGENT_EXPLANATION\"","mentor_memory_store","mentor_memory_unfinished","mentor_memory_candidates","/api/agent/memory/proposals","DELETE MEMORY","room.mentor.memory.title"];
