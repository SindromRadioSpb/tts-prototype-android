...
const EXPECTED = {
  ru: ['Находить одобренные публичные корпуса и материалы', 'Читать одобренные окна текста из публикаций', 'Получать ссылки и хеши одобренных ресурсов'],
  en: ['Discover approved public corpora and items', 'Read approved publication text windows', 'Read approved resource links and hashes'],
  he: ['איתור קורפוסים ופריטים ציבוריים מאושרים', 'קריאת חלונות טקסט מאושרים מפרסומים', 'קריאת קישורים וגיבובים של משאבים מאושרים'],
};
...
try {
  ...
  assert.equal(await page.locator('.scope-card').count(), 8); checks++;
