...
async function main(){
  ...
  const migrations=await import('../../public/db/migrations.js');if(migrations.MIGRATIONS.length!==48)throw new Error('MIGRATION_COUNT:'+migrations.MIGRATIONS.length);db.run(migrations.MIGRATIONS[45]);
